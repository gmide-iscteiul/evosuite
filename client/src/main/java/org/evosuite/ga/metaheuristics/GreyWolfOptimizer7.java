 ...
 * @author 
 */
public class GreyWolfOptimizer7<T extends Chromosome<T>> extends GeneticAlgorithm<T> {
	...
	private final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(GreyWolfOptimizer7.class);
	 ...
	 */
	public GreyWolfOptimizer7(ChromosomeFactory<T> factory) {
		super(factory);
	}
