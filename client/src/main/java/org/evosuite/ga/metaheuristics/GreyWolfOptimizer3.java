 ...
 * @author 
 */
public class GreyWolfOptimizer3<T extends Chromosome<T>> extends GeneticAlgorithm<T> {
	...
	private final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(GreyWolfOptimizer3.class);
	 ...
	 */
	public GreyWolfOptimizer3(ChromosomeFactory<T> factory) {
		super(factory);
	}
