...
public class ChickenSwarmOptimizationSystemTest extends SystemTestBase {
	public List<Chromosome> setup(StoppingCondition sc, int budget, String cut) {
		Properties.CRITERION = new Criterion[1];
		Properties.CRITERION[0] = Criterion.BRANCH;
		Properties.ALGORITHM = Algorithm.CHICKEN_SWARM_OPTIMIZATION;
		Properties.POPULATION = 25;
		Properties.STOPPING_CONDITION = sc;
		Properties.SEARCH_BUDGET = budget;
		Properties.NUMBER_OF_ROOSTERS = 5;
		Properties.NUMBER_OF_MOTHER_HENS = 5;
		Properties.NUMBER_OF_CHICKS = 5;
		Properties.CHICKEN_SWARM_UPDATE_INTERVAL = 3;
	...
	@Test
	public void testChickenSwarmOptimizationWithLimitedTime() {
	...
	@Test
	public void testChickenSwarmOptimizationWithLimitedGenerations() {
